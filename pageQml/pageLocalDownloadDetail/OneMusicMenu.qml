...
QCMenu { // 右键菜单
    ...
    QCMenuItem { // 播放
        ...
        function playOneMusic() {
            let contentData = musicLocalDownloadPage.contentData
            ...
            console.log("PageLocalDownloadDetail.qml: " + findIndex)
            if(findIndex === -1) {
    ...
    QCMenuItem { // 添加到指定歌单
        ...
        onClicked: {
            ...
            if(cmp.status === Component.Ready) {
                ...
                cmp.musicInfo = musicLocalDownloadPage.contentData[rightMenu.playListCurrent]
                cmp.open()
            }
        }
