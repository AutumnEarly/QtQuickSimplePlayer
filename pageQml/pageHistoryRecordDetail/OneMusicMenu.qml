...
QCMenu { // 右键菜单
    ...
    QCMenuItem { // 播放
        ...
        function playOneMusic() {
            let contentData = historyRecordPage.contentData
            ...
            console.log("PageHistoryRecordDetail.qml: " + findIndex)
            if(findIndex === -1) {
    ...
    QCMenuItem { // 添加到指定歌单
        ...
        onClicked: {
            ...
            if(cmp.status === Component.Ready) {
                ...
                cmp.musicInfo = historyRecordPage.contentData[rightMenu.playListCurrent]
                cmp.open()
            }
        }
